...
int main(){
    ...
    cena.add_sphere(sphere(0, -1, 3, 1, 500, px::convert_rgb(255, 0, 0))); //sphere(x, y, z), radio, and sphere color
    cena.add_sphere(sphere(2, 0, 4, 1, 500, px::convert_rgb(0, 0, 255))); //sphere(x, y, z), radio, and sphere color
    cena.add_sphere(sphere(-2, 0, 4, 1, 10, px::convert_rgb(0, 255, 0))); //sphere(x, y, z), radio, and sphere color
    cena.add_sphere(sphere(0, -5001, 0, 5000, 1000, px::convert_rgb(255, 255, 0))); //sphere(x, y, z), radio, and sphere color
