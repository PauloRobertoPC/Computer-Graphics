...
int main(){
    ...
    cena.add_object(new cone(vp(-69.282, 69.282, -169.282), vp(-1/sqrt(3.0), 1/sqrt(3.0), -1/sqrt(3.0)), 1.5*R, R/3.0, px(0.8, 0.3, 0.2), px(0.8, 0.3, 0.2), px(0.8, 0.3, 0.2), 10, true)); 
