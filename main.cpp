...
scene ball_reflection()
{
    ...
    cena.add_object(new sphere(vp(2, 1, 3), 1, px(px::convert_rgb(0, 255, 0)), px(px::convert_rgb(0, 255, 0)), px(px::convert_rgb(0, 255, 0)), 10, 0.4, 0.0, 1.5));
...
scene cena_doida(){
    ...
    cena.add_object(new plan(vp(0, 0, -1000), vp(0, 0, 1), px(px::convert_rgb(135, 206, 235)), px(px::convert_rgb(135, 206, 235)), px(px::convert_rgb(135, 206, 235)), 500, 0, 0.0, 1.3));
    cena.add_object(new plan(vp(0, -10, 0), vp(0, 1, 0), px(px::convert_rgb(0, 255, 0)), px(px::convert_rgb(0, 255, 0)), px(px::convert_rgb(0, 255, 0)), 500, 0, 0.0, 1.3));
    cena.add_object(new plan(vp(0, 0, 1000), vp(0, 0, -1), px(px::convert_rgb(255, 255, 255)), px(px::convert_rgb(255, 255, 255)), px(px::convert_rgb(255, 255, 255)), 500, 0, 0.0, 1.3));

    cena.add_light(new ambient_light(px(0.2, 0.2, 0.2)));
    cena.add_light(new point_light(px(0.6, 0.6, 0.6), vp(0, 10, 0)));
